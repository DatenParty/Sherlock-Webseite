...
echo "<title>" .  $_GET["category"] . " - Daten Party</title>";
} else {
echo "<title>News - Daten Party</title>";
}
?>
  ...
  <div class="cc-tp-padding-container cc-content-parent">
    <div class="cc-tp-container cc-content-parent">
              	...
              	<tr>
                    ...
                    <div class="logo">
                      <a href="index.html" title="News - Daten Party">
              		        <img src="img/datenparty4.png" height="66" width="313" src="" alt="" border= 0px>
                      </a>
                    </div>
              	</tr>
              </table>
      ...
      <div class="cc-tp-main cc-tp-gutter cc-content-parent">
        ...
        <div id="cc-matrix-2401172421"><div id="cc-m-9485597621" class="j-module n j-header"><h1 class="" id="cc-m-header-9485597621">
<?php
if(isset($_GET["category"])){
echo $_GET["category"];
} else {
...
?>
</h1></div><div id="cc-m-9498195821" class="j-module n j-spacing">
...
$amount = 0;
foreach($test as $lol) {
if(isset($_GET["category"]) and $test[$amount]["category"] != $_GET["category"]){
}else{
?>

</div><div id="cc-m-9497616221" class="j-module n j-blogSelection"><div class="blogselection">
...
<div id="cc-matrix-2502506221"><div id="cc-m-9497606721" class="j-module n j-text">
<p>
...
Kategorie:
<?php
$ctgry = $test[$amount]["category"];
echo '<a href="index.php?category=' . $ctgry . '">' . $ctgry . '</a>';
?> 
<br>
</p>
<p><br>
...
</div><div id="cc-m-9485590721" class="j-module n j-text"><p>
<?php
}
$amount += 1;
}
...
</div><div id="cc-m-9168598421" class="j-module n j-hr"><hr></div></div>
...
<div class="j-meta-links">
        <a href="about.html">Impressum</a> | <a href="contact.html">Kontakt</a><br>
    </div>
